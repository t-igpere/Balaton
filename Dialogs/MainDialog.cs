...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    ...
    {
        private readonly GeneralRecognizer _luisRecognizer;
        protected readonly ILogger Logger;

        // Dependency injection uses this constructor to instantiate MainDialog
        public MainDialog(GeneralRecognizer luisRecognizer, BookingDialog bookingDialog, ILogger<MainDialog> logger)
